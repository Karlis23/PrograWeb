...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2013 a las 16:30:41
...
CREATE TABLE IF NOT EXISTS `aparador` (
  `id_aparador` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_estante` varchar(8) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `libro` (
  ...
  `id_aparador` int(11) DEFAULT NULL,
